  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      <el-form-item label="机构查询" prop="orgName">
        <el-input v-model="queryParams.orgName" placeholder="请输入名称/机构编码" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="所在区域" prop="jurisdictionCode">
        <el-cascader v-model="queryParams.jurisdictionCode" @change="cascaderChange" :options="provinceList"
          :props="props" style="width: 100%;"></el-cascader>
      </el-form-item>
      <el-form-item label="医院层级" prop="hosTier">
        <el-select v-model="queryParams.hosTier" placeholder="请选择" style="width: 100%;">
          <el-option v-for="item in hosTierList" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="医院类别" prop="hosType">
        <el-select v-model="queryParams.hosType" placeholder="请选择" style="width: 100%;">
      ...
      <el-form-item label="医院等级" prop="hosLevel">
        <el-select v-model="queryParams.hosLevel" placeholder="请选择" style="width: 100%;">
    ...
    <el-table v-if="refreshTable" :data="deptList" row-key="deptId" :default-expand-all="isExpandAll"
      ...
      <el-table-column label="服务模式" align="center" prop="serviceType">
        <template slot-scope="scope">
          <div>{{ getDictList(scope.row.serviceType, 'serviceTypelist', 'array') }}</div>
        </template>
      </el-table-column>
      ...
      <el-table-column label="咨询热线" align="center" prop="hosTel"></el-table-column>
    ...
    <div class="footer">
      <el-pagination background layout="prev, pager, next" :total="total" @current-change="currentChage">
      </el-pagination>
    </div>
    ...
    <el-drawer :title="title" :visible.sync="open" size="500px" append-to-body>
      <div style="margin: 24px;">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row>
            ...
            <el-col :span="24">
              <el-form-item label="机构简介" prop="orgShortName">
                <el-input placeholder="请输入" v-model="form.orgShortName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
            ...
            <el-col :span="24">
              <el-form-item label="医院层级" prop="hosTier">
                <el-select v-model="form.hosTier" placeholder="请选择" style="width: 100%;">
                  <el-option v-for="item in hosTierList" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="24">
              <el-form-item label="医院等级" prop="hosLevel">
                <el-select v-model="form.hosLevel" placeholder="请选择" style="width: 100%;">
                  <el-option v-for="item in levels" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="24">
              <el-form-item label="行政所属" prop="jurisdictionCode">
                <el-cascader ref="jurisdiction" v-model="form.jurisdictionCode" @change="cascaderChange"
                  :options="provinceList" :props="props" style="width: 100%;"></el-cascader>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="所在区域" prop="areaCode">
                <el-cascader ref="area" v-model="form.areaCode" @change="cascaderChange" :options="provinceList"
                  :props="props" style="width: 100%;"></el-cascader>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="机构经纬度" label-width="90px">
                <div style="display: flex;gap: 20px;">
                  <el-input placeholder="填写经度" v-model="form.hosLongitude"></el-input>
                  <el-input placeholder="填写纬度" v-model="form.hosLatitude"></el-input>
                </div>
              </el-form-item>
            </el-col>
            <el-col :span="24">
            ...
            <el-col :span="24">
              <el-form-item label="机构图片" label-width="90px" prop="hosIcon">
                <el-upload ref="upload" :show-file-list="false" :before-upload="beforeAvatarUpload"
                  :on-remove="medicalFileRemove" accept=".jpg, .png, .pdf" :action="upload.url" list-type="picture-card"
                  :headers="upload.headers" :on-success="handleMedicalSuccess">
          ...
          <h2 style="font-size: 16px;width: 100%;padding: 20px 0; border-top: 1px solid #f1f1f1;">安宁疗护信息</h2>
          <el-row>
            <el-col :span="24">
              <el-form-item label="服务模式" label-width="90px" prop="serviceType">
            ...
            <el-col :span="24">
              <el-form-item label="咨询时间" label-width="90px" prop="consultationTime">
                <el-date-picker v-model="form.consultationTime" type="date" placeholder="选择日期" style="width: 100%;">
                </el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="医院介绍" label-width="90px" prop="hosInfo">
                <el-input placeholder="请输入" v-model="form.hosInfo"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
...
import { listDept, getDept, delDept, saveHosInfo, updateDept, listDeptExcludeChild } from "@/api/system/dept";
    ...
    submitForm: function () {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          let params = {
            ...this.form,
            jurisdictionCode: jurisdictionCode ? jurisdictionCode[jurisdictionCode.length - 1] : "",
            areaCode: areaCode ? areaCode[areaCode.length - 1] : "",
            jurisdictionName: jurisdictionNode.length ? jurisdictionNode[0].label : "",
