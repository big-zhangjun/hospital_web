      ...
      <div style="margin: 24px;">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row>
            ...
            <el-col :span="24">
              <el-form-item label="所属机构" prop="belongArea" >
                <el-cascader v-model="form.belongArea" @change="cascaderChange" :options="provinceList" :props="props" style="width: 100%;"></el-cascader>
              </el-form-item>
            </el-col>
            <el-col :span="24">
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, resetUserPwd, changeUserStatus, deptTreeSelect, getRegion } from "@/api/system/user";
