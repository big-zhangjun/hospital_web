    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
            <el-form-item label="信息查询" prop="name">
                <el-input v-model="queryParams.name" placeholder="请输入名称/机构编码" clearable
            ...
            <el-form-item label="组别" prop="orgId">
                <el-select v-model="queryParams.majorType" placeholder="请选择" style="width: 100%">
                    <el-option v-for="(item, idx) in majorTypeList" :key="idx" :label="item.label" :value="item.value">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="地区" prop="orgId">
                <el-cascader ref="serviceAreaEl" v-model="queryParams.serviceArea" :options="provinceList"
                    :props="queryProps" style="width: 100%"></el-cascader>
            </el-form-item>
            <el-form-item>
                    ...
                    <el-row>
                        ...
                        <el-col :span="24">
                            <el-form-item label="组别" prop="majorType">
                                <el-select v-model="form.majorType" placeholder="请选择" style="width: 100%">
                                    <el-option v-for="(item, idx) in majorTypeList" :key="idx" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                        ...
                        <el-col :span="24">
                            <el-form-item label="服务地区" prop="serviceArea">
                                <el-cascader ref="service" v-model="form.serviceArea" :options="provinceList"
                        ...
                        <el-col :span="24">
                            <el-form-item label="团队成员" prop="members">
                                <el-select multiple v-el-select-loadmore="handleDeptScroll" v-model="form.members"
                                    placeholder="请选择" style="width: 100%">
                                    <el-option v-for="(item, idx) in docList" :key="idx"
                                        :label="item.name + ` (${item.titleName}) ${item.phone}`" :value="item.id">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        ...
                        <el-col :span="24">
                            <el-form-item label="队长" prop="captainDoctorId">
                                <el-select clearable v-el-select-loadmore="handleDeptScroll"
                                    v-model="form.captainDoctorId" placeholder="请选择" style="width: 100%">
                                    <el-option v-for="(item, idx) in docList" :key="idx" :label="item.name"
                                        :value="item.id">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                        ...
                        <el-col :span="24">
                            <el-form-item label="秘书" prop="secretaryDoctorId">
                                <el-select clearable v-el-select-loadmore="handleDeptScroll"
                                    v-model="form.secretaryDoctorId" placeholder="请选择" style="width: 100%">
                                    <el-option v-for="(item, idx) in docList" :key="idx" :label="item.name"
                                        :value="item.id">
                                    </el-option>
                                </el-select>
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            let serviceArea = this.$refs.serviceAreaEl.getCheckedNodes().map((item) => {
                return {
                    level: item.level,
                    code: item.value,
                    name: item.label
        ...
        handleUpdate(row) {
            ...
            getMdtTeam({ id: row.id }).then((response) => {
                ...
                this.form.serviceArea = response.data.serviceArea.map(item => item.code)
        ...
        /** 提交按钮 */
        submitForm: function () {
            let serviceAreaNode = this.$refs.service.getCheckedNodes()
