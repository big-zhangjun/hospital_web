  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      <el-form-item label="信息查询" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入名称/机构编码" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-drawer :title="title" :visible.sync="open" size="500px" append-to-body>
      <div style="margin: 24px">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row>
            <el-col :span="24">
              <el-form-item label="机构信息" prop="orgId">
            ...
            <el-col :span="24">
              <el-form-item label="团队成员" prop="members">
                <el-select multiple v-el-select-loadmore="handleDeptScroll" v-model="form.members" placeholder="请选择"
                  style="width: 100%">
            ...
            <el-col :span="24">
              <el-form-item label="队长" prop="captainDoctorId">
                <el-select clearable v-el-select-loadmore="handleDeptScroll" v-model="form.captainDoctorId"
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      this.type = 'edit'
      this.reset();
      getTeam({ id: row.id }).then(response => {
    ...
    submitForm: function () {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          if (this.type == 'edit') {
            updateTeam({ ...this.form, members }).then((response) => {
            ...
            addTeam({ ...this.form, members }).then((response) => {
