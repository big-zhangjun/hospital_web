    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
            ...
            <el-form-item label="所在机构" prop="orgId">
                <el-select v-model="queryParams.orgId" placeholder="请选择" style="width: 100%">
                    <el-option v-for="item in orgList" :key="item.id" :label="item.orgName" :value="item.id">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="职业类别" prop="docType">
                <el-select v-model="queryParams.docType" placeholder="请选择" style="width: 100%">
                    <el-option v-for="item in docTypeList" :key="item.code" :label="item.name" :value="item.code">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="职称" prop="titleId">
                <el-select v-model="queryParams.titleId" placeholder="请选择" style="width: 100%">
                    <el-option v-for="item in titleIdList" :key="item.id" :label="item.name" :value="item.id">
                    </el-option>
                </el-select>
            </el-form-item>
            ...
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="address" label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button style="margin-left: 12px;" size="mini" type="text" icon="el-icon-delete"
                    ...
                    <el-row>
                        ...
                        <el-col :span="24">
                            <el-form-item label="所属科室" prop="orgId">
                                <el-select v-el-select-loadmore="handleDeptScroll" v-model="form.deptId"
                        ...
                        <el-col :span="24">
                            <el-form-item label="职称" prop="titleId">
                                <el-select v-model="form.titleId" placeholder="请选择" style="width: 100%">
                                    <el-option v-for="item in titleIdList" :key="item.id" :label="item.name"
                                        :value="item.id">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                        ...
                        <el-col :span="24">
                            <el-form-item label="照片" prop="docIcon">
                                <el-upload ref="upload" :show-file-list="false" :before-upload="beforeAvatarUpload"
                                    :on-remove="medicalFileRemove" accept=".jpg, .png, .pdf" :action="upload.url"
                                    list-type="picture-card" :headers="upload.headers"
    ...
    data() {
        return {
            ...
            rules: {
                ...
                docType: [{ required: true, message: "职业类别不能为空", trigger: "blur" }],
    ...
    methods: {
        ...
        submitForm: function () {
            this.$refs["form"].validate((valid) => {
                if (valid) {
                    let deptData = this.deptList.find(item => item.id == this.form.deptId)
                    if (deptData) {
                        this.form.deptName = deptData.name
                    }
                    if (this.type == 'edit') {
                        updateDoctor({ ...this.form, sort: 1, certType: '1', dutyType: '2' }).then((response) => {
                        ...
                        addDoctor({ ...this.form, sort: 1, certType: '1', dutyType: '2' }).then((response) => {
